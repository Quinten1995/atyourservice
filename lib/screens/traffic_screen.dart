...
class _TrafficScreenState extends State<TrafficScreen> {
  ...
  Future<void> _fetchTrafficData() async {
    ...
    try {
      ...
      // 5) Kategorien zählen & absteigend sortieren
      final Map<String, int> kategorieCounts = {};
      for (var item in regionDienstleister) {
        final String kategorie = item['kategorie'] ?? 'Unbekannt';
  ...
  Widget build(BuildContext context) {
    ...
    // ### NEU: maxCount einmalig berechnen (für stabile Normalisierung)
    final int? maxCount = (_trafficData == null || _trafficData!.isEmpty)
        ? null
        : _trafficData!
              .map((e) => (e['anzahl'] as num).toInt())
              .reduce((a, b) => a > b ? a : b);
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        l10n.trafficScreenInfoText, // z.B.: „Übersicht im Umkreis (20 km): Anzahl pro Kategorie.“
                        style: TextStyle(
            ...
            child: _isLoading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String kategorie = entry['kategorie'] as String;
                      final int anzahl = (entry['anzahl'] as num).toInt();

                      // ### NEU: stabile Normalisierung
                      double progress = (maxCount == null || maxCount == 0)
                          ? 0
                          : anzahl / maxCount.toDouble();

                      // ### NEU: Sichtbarkeits-Floor (5%), damit Mini-Kategorien sichtbar bleiben
                      const double minBar = 0.05;
                      if (progress > 0 && progress < minBar) progress = minBar;
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(
                              width: 70,
                              // ### NEU: Animation der Balken (fährt von links ein)
                              child: TweenAnimationBuilder<double>(
                                tween: Tween<double>(begin: 0, end: progress),
                                duration: Duration(
                                  milliseconds: 700 + (index * 30),
                                ),
  ...
  String getKategorieName(String kategorie) {
    switch (kategorie) {
      case 'category_babysitter':
        return category_babysitter;
      case 'category_catering':
        return category_catering;
      case 'category_dachdecker':
        return category_dachdecker;
      case 'category_elektriker':
        return category_elektriker;
      case 'category_ernaehrungsberatung':
        return category_ernaehrungsberatung;
      case 'category_eventplanung':
        return category_eventplanung;
      case 'category_fahrdienste':
        return category_fahrdienste;
      case 'category_fahrlehrer':
        return category_fahrlehrer;
      case 'category_fensterputzer':
        return category_fensterputzer;
      case 'category_fliesenleger':
        return category_fliesenleger;
      case 'category_fotografie':
        return category_fotografie;
      case 'category_friseur':
        return category_friseur;
      case 'category_gartenpflege':
        return category_gartenpflege;
      case 'category_grafikdesign':
        return category_grafikdesign;
      case 'category_handy_reparatur':
        return category_handy_reparatur;
      case 'category_haushaltsreinigung':
        return category_haushaltsreinigung;
      case 'category_hausmeisterservice':
        return category_hausmeisterservice;
      case 'category_heizungsbauer':
        return category_heizungsbauer;
      case 'category_hundesitter':
        return category_hundesitter;
      case 'category_it_support':
        return category_it_support;
      case 'category_klempner':
        return category_klempner;
      case 'category_kosmetik':
        return category_kosmetik;
      case 'category_kuenstler':
        return category_kuenstler;
      case 'category_kurierdienst':
        return category_kurierdienst;
      case 'category_maler':
        return category_maler;
      case 'category_massagen':
        return category_massagen;
      case 'category_maurer':
        return category_maurer;
      case 'category_moebelaufbau':
        return category_moebelaufbau;
      case 'category_musikunterricht':
        return category_musikunterricht;
      case 'category_nachhilfe':
        return category_nachhilfe;
      case 'category_nagelstudio':
        return category_nagelstudio;
      case 'category_pc_reparatur':
        return category_pc_reparatur;
      case 'category_partyservice':
        return category_partyservice;
      case 'category_personal_trainer':
        return category_personal_trainer;
      case 'category_rasenmaeher_service':
        return category_rasenmaeher_service;
      case 'category_rechtsberatung':
        return category_rechtsberatung;
      case 'category_reparaturdienste':
        return category_reparaturdienste;
      case 'category_seniorenbetreuung':
        return category_seniorenbetreuung;
      ...
      case 'category_sprachunterricht':
        return category_sprachunterricht;
      case 'category_steuerberatung':
        return category_steuerberatung;
      case 'category_tischler':
        return category_tischler;
      case 'category_transport':
        return category_transport;
      case 'category_umzugstransporte':
        return category_umzugstransporte;
      case 'category_umzugshelfer':
        return category_umzugshelfer;
      case 'category_uebersetzungen':
        return category_uebersetzungen;
      case 'category_waescheservice':
        return category_waescheservice;
      case 'category_webdesign':
        return category_webdesign;
      case 'category_einkaufsservice':
        return category_einkaufsservice;
      case 'category_haustierbetreuung':
        return category_haustierbetreuung;
      default:
        return kategorie;
    }
  }
